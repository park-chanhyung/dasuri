...
public interface ReviewRepository extends JpaRepository<ReviewEntity,Long> {
    ...
    @Query("SELECT r.shopEntity, COUNT(r) FROM ReviewEntity r GROUP BY r.shopEntity ORDER BY COUNT(r) DESC")
    List<Object[]> findShopsWithMostReviews(Pageable pageable);
}